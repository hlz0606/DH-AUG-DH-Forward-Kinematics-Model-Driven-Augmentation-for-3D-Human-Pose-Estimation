...
from function_aug.model_pos_eval import evaluate
...
def main(args):
    ...
    criterion = nn.MSELoss(reduction='mean').to(device)    # loss
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        epoch_loss, lr_now, glob_step = \
            train(data_dict['train_loader'], model_pos, criterion, optimizer, device, args.lr, lr_now,
