...
####### 预测的关键点和实际关键点之间的误差小于150mm就认为是正确预测到,计算这个概率
...
def compute_AUC(gts, preds, scales=1000, eval_joints=None):
    # 此阈值范围模拟“mpii_compute_3d_pck.m”，它作为
    # MPI-INF-3DHP测试数据发布。
